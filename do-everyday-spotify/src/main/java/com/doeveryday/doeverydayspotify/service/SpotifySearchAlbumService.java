...
@AllArgsConstructor
@Service
public class SpotifySearchAlbumService {

    private final SpotifyApi spotifyApi;

    public List<AlbumSimplified> getTracksByName(String name){
    ...
    public List<AlbumSimplified> getTracksByName(String name, Integer limit){
        List<AlbumSimplified> albums = new ArrayList<>();
        try {
