...
create table user (id varchar(255) not null, account_non_expired bit default 1 not null, account_non_locked bit default 1 not null, credentials_non_expired bit default 1 not null, email varchar(255), enabled bit default true not null, password varchar(255) not null, photo longblob, role integer not null, username varchar(255) not null, primary key (id)) engine=InnoDB;
